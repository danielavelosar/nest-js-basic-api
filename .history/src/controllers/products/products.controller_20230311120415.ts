...
export class ProductsController {
   ...
   getProduct(@Param(ParseIntPipe) params: any) {
      //ParseIntPipe es un pipe que convierte el string a int
      // return {
   ...
   @Get(':productId/info')
   getInfoProduct(@Param('productId', ParseIntPipe) productId: number) {
      // return {
   ...
   @Put(':productId')
   updateProduct(
      @Param('productId', ParseIntPipe) productId: any,
   ...
   @Delete(':productId')
   deleteProduct(@Param('productId', ParseIntPipe) productId: any) {
      // return {
